...
import { FlutterCommandsProvider } from './flutterCommandsProvider.js';

export function activate(context: vscode.ExtensionContext) {
    console.log('Flutter Dev Commands extension is now active!');

    // Create the tree data provider
    const flutterCommandsProvider = new FlutterCommandsProvider();
...
async function executeFlutterCommand(command: string) {
    try {
